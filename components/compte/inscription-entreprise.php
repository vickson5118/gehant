...
<body>
		...
		<div class="container">
			...
			<div class="text-boost-container">
				...
				<div class="mentor">
					...
					<div>De nombreux mentors disponibles pour accompagner la
						progression de vos employés</div>
				</div>
			...
			<div class="form-inscription-entreprise-container">
				...
				<form class="form-box">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 form-input-container">
							<label for="objectif">Votre objectif*</label> <select
