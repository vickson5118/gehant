        ...
        <div class="row">
            ...
            <div class="col-md-9 formation-infos-container">
                ...
                <div class="section-content">
                    <p>
                        <i class="bi bi-info-circle-fill"></i> C'est ici que vous ajoutez du contenu tel que les
                        principaux thematiques du jour et les exercices de la formation.
                    </p>

                    <p>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#staticBackdropCreateModule">Créer un module
                        </button>
                        <!--
                    ...
                    <div class="liste-formation-module-container">
                        <?php foreach ($listeModule as $key => $module) { ?>
                            <div class="one-module">
                                <h3>Jour <?= ($key + 1) ?> - <span
                                            class="module-title"><?= $module->getTitre() ?></span></h3>

                                <div class="module-btn">
                                    <button type="button" class="btn-edit-module" title="Editer le titre du module"
                                            value="<?= $module->getId(); ?>" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdropEditModule">
                                        <i class="bi bi-pencil-fill"></i>
                                    </button>

                                    <button type="button" class="add-module-point-cle"
                                            title="Ajouter un point clé du module" value="<?= $module->getId(); ?>"
                                            data-bs-toggle="modal" data-bs-target="#staticBackdropCreateModulePointCle">
                                        <i class="bi bi-plus-square"></i>
                                    </button>

                                    <button type="button" class="btn-delete-module" title="Supprimer le module"
                                            value="<?= $module->getId(); ?>" data-bs-toggle="modal"
                                    ...
                                    <?php foreach ($listePointCle as $pointCle) {
                                        if ($pointCle->getModule()->getId() == $module->getId()) {
                                            ...
                                            <li><span class="point-title"><?= $pointCle->getTitre(); ?></span>
                                                <button type="button" class="btn-edit-module-point-cle"
                                                        title="Editer le point clé du module"
                                                        value="<?= $pointCle->getId(); ?>" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdropEditModulePointCle">
                                                    <i class="bi bi-pencil-fill"></i>
                                                </button>

                                                <button type="button" class="btn-delete-module-point-cle"
                                                        title="Supprimer le module" value="<?= $pointCle->getId(); ?>"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#deleteModulePointCleModal">
                                                    <i class="bi bi-x-square"></i>
                                                </button>
