                        ...
                        <div>
                            ...
                            <form id="prerequis-form">
                                <?php if ($formation->getPrerequis() == null) { ?>
                                    <input type="text" id="prerequis-1" class="form-control"
                                           placeholder="Exemple : Avoir des competences en management">
                                <?php } else {
                                    $listePrerequis = explode(";", $formation->getPrerequis());
                                    foreach ($listePrerequis as $key => $prerequis) {
                                        ?>
                                        <input type="text" value="<?= $prerequis ?>" id="prerequis-<?= ($key + 1) ?>"
                                               class="form-control"
                                               placeholder="Exemple : Avoir des competences en management">
                                    <?php } ?>
                                <?php } ?>
