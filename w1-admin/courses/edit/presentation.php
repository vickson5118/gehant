                ...
                <div class="section-content">
                    ...
                    <form method="post" enctype="multipart/form-data" id="basics-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="titre" value="<?= $formation->getTitre() ?>" class="form-control"
                                   id="titre" placeholder="Ex: Comprendre le droit">
                            <div class="error"></div>
                        </div>

                        <div class="mb-3">
                            <label for="but" class="form-label">But de la formation</label>
                            <input type="text" name="but" value="<?= $formation->getBut() ?>" class="form-control"
                                   id="but" placeholder="Ex: Intégrer les fondamentaux du droit">
                            <div class="error"></div>
                        </div>

                        <div class="mb-3">
                            <label for="lieu" class="form-label">Lieu de la formation</label>
                            <input type="text" name="lieu" value="<?= $formation->getLieu() ?>" class="form-control"
                                   id="lieu" placeholder="Ex: 2 plateaux">
                            <div class="error"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="debut" readonly="readonly" id="debut" class="form-control"
                                       value="<?= $formation->getDateDebut() ?>" placeholder="Ex: 10/06/2021"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fin" readonly="readonly" id="fin" class="form-control"
                                       value="<?= $formation->getDateFin() ?>" placeholder="Ex: 15/06/2021"
                                       style="background-color: transparent;"/>
                                <div class="error"></div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="domaine" name="domaine">
                                    <?php foreach ($listeDomaine as $domaine) { ?>
                                        <option value="<?= $domaine->getId() ?>"
                                                <?php if ($_SESSION["formation"]->getDomaine()->getId() == $domaine->getId()){ ?>selected="selected" <?php } ?> ><?= ucfirst(strtolower($domaine->getTitre())) ?></option>
                                    <?php } ?>
                                </select>
                                <div class="error"></div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="prix" type="text" value="<?= $formation->getPrix() ?>" class="form-control"
                                       id="prix" placeholder="Exemple: 15000">
                                <div class="error"></div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="description"
                                      rows="6"><?= $formation->getDescription() ?></textarea>
                            <div class="error"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="illustration-directives col-md-5" style="margin-top: 110px;">
                                <p>Téléchargez votre image de cours ici. Pour être acceptée, elle doit répondre à nos
                                    normes de qualité
                                    relatives aux images de cours. Directives importantes : 1920 x 900 pixels ; format
                                    .jpg, .jpeg, ou .png ;
                                    aucun texte sur l'image.</p>

                                <input class="form-control" type="file" id="formationIllustration"
                                       name="formationIllustration" accept="image/*">
