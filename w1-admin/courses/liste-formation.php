...
foreach($listeFormation as $formation){
    ...
    if( !$formation -> getBloquer() && $formation -> getRedactionFinished() && Functions::convertDateFrToEn($formation -> getDateDebut()) > date("Y-m-d")){
        $formationActif = true;
    }
...
<body>
		...
		<div class="container-fluid">
			...
			<button type="button" class="btn btn-primary" data-bs-toggle="modal"
				data-bs-target="#staticBackdropCreateFormation">Créer une formation</button>
        ...
        foreach($listeFormation as $formation){
            if($formation -> getBloquer()){
                ...
                ?>
								...
								<td class="row-email"><?= $formation->getAuteur()->getEmail() ?></td>
								<td class="row-domaine"><?= ucfirst(strtolower($formation->getDomaine()->getTitre())) ?></td>
								<td class="row-domaine-url" style="display: none;"><?= $formation->getDomaine()->getTitreUrl() ?></td>
								<td><?= $formation->getNombreAchat() ?></td>
